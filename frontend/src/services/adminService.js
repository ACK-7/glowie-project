...
export const getRecentActivity = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/dashboard/recent-activity`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getBooking = async (id) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/admin/crud/bookings/${id}`,
      {
        headers: getAuthHeaders(),
      },
    );
...
export const createBooking = async (data) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/bookings`,
    data,
    {
      headers: getAuthHeaders(),
    },
...
export const updateBookingStatus = async (id, status) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/bookings/${id}/status`,
    { status },
    {
      headers: getAuthHeaders(),
    },
...
export const getCustomer = async (id) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/customers/${id}`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const createCustomer = async (data) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/customers`,
    data,
    {
      headers: getAuthHeaders(),
    },
...
export const updateCustomerStatus = async (id, status) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/customers/${id}/status`,
    {
      status,
...
export const verifyCustomer = async (id) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/customers/${id}/verify`,
    {},
    {
      headers: getAuthHeaders(),
    },
...
export const resetCustomerPassword = async (id) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/customers/${id}/reset-password`,
    {},
    {
      headers: getAuthHeaders(),
    },
...
export const getCustomerBookings = async (id) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/customers/${id}/bookings`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getCustomerCommunications = async (id) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/customers/${id}/communications`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getCustomerStatistics = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/customers/statistics`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getCustomersRequiringAttention = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/customers/requires-attention`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const searchCustomers = async (query) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/customers/search`,
    {
      headers: getAuthHeaders(),
      params: { query },
    },
...
export const exportCustomers = async (params = {}) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/customers/export`,
    params,
    {
      headers: getAuthHeaders(),
      responseType: "blob",
...
export const updateQuote = async (id, data) => {
  const response = await axios.put(
    `${API_BASE_URL}/admin/crud/quotes/${id}`,
    data,
    {
      headers: getAuthHeaders(),
    },
...
export const approveQuote = async (id, notes = null) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/quotes/${id}/approve`,
    {
      notes,
    },
    {
...
export const rejectQuote = async (id, reason = null) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/quotes/${id}/reject`,
    {
      reason,
    },
    {
...
export const convertQuoteToBooking = async (id) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/quotes/${id}/convert`,
    {},
    {
      headers: getAuthHeaders(),
    },
...
export const extendQuoteValidity = async (id, newExpiryDate) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/quotes/${id}/extend`,
    {
...
export const getQuotesRequiringApproval = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/quotes/requires-approval`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getExpiringQuotes = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/quotes/expiring-soon`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const processExpiredQuotes = async () => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/quotes/process-expired`,
    {},
    {
      headers: getAuthHeaders(),
    },
...
export const getQuoteStatistics = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/quotes/statistics`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getQuoteAnalytics = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/quotes/analytics`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getShipment = async (id) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/${id}`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const createShipment = async (data) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/shipments`,
    data,
    {
      headers: getAuthHeaders(),
    },
...
export const updateShipmentStatus = async (
  ...
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/shipments/${id}/status`,
    {
      status,
      location,
      notes,
...
export const updateEstimatedArrival = async (
  id,
  estimatedArrival,
  reason = null,
) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/shipments/${id}/estimated-arrival`,
    {
...
export const trackShipment = async (trackingNumber) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/track/${trackingNumber}`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getShipmentsRequiringAttention = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/requires-attention`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getShipmentStatistics = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/statistics`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const processDelayedShipments = async () => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/shipments/process-delayed`,
    {},
    {
      headers: getAuthHeaders(),
    },
...
export const getDeliveryPerformance = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/delivery-performance`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const getCarrierPerformance = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/carrier-performance`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const searchShipments = async (query) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/search`,
    {
      headers: getAuthHeaders(),
      params: { query },
    },
...
export const getRecentShipments = async (limit = 10) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/recent`,
    {
      headers: getAuthHeaders(),
      params: { limit },
    },
...
export const getShipmentTrends = async (days = 30) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/shipments/trends`,
    {
      headers: getAuthHeaders(),
      params: { days },
    },
...
export const getFinanceStats = async () => {
  ...
  console.log(
    "Making request to:",
    `${API_BASE_URL}/admin/crud/payments/statistics`,
  );
...
export const processRefund = async (id, amount, reason) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/payments/${id}/refund`,
    {
      amount,
      reason,
    },
...
export const exportPayments = async (params = {}) => {
  const response = await axios.post(
    `${API_BASE_URL}/admin/crud/payments/export`,
    params,
    {
      headers: getAuthHeaders(),
      responseType: "blob",
...
export const getFinancialSummary = async (dateRange = {}) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/analytics/financial-summary`,
    {
      headers: getAuthHeaders(),
      params: dateRange,
    },
...
export const getDocuments = async (params = {}) => {
  try {
    ...
    if (params.booking_id) {
      const response = await axios.get(
        `${API_BASE_URL}/admin/crud/documents/booking/${params.booking_id}`,
        {
          headers: getAuthHeaders(),
        },
      );
...
export const getDocument = async (id) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/documents/${id}`,
    {
      headers: getAuthHeaders(),
    },
  );
...
export const approveDocument = async (id, notes = "") => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/documents/${id}/approve`,
    {
      notes,
    },
    {
...
export const rejectDocument = async (id, reason) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/documents/${id}/reject`,
    {
      reason,
    },
    {
...
export const downloadDocument = async (id) => {
  const response = await axios.get(
    `${API_BASE_URL}/admin/crud/documents/${id}/download`,
    {
      headers: getAuthHeaders(),
      responseType: "blob",
    },
...
export const bulkApproveDocuments = async (documentIds, notes = "") => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/documents/bulk-approve`,
    {
...
export const bulkRejectDocuments = async (documentIds, reason) => {
  const response = await axios.patch(
    `${API_BASE_URL}/admin/crud/documents/bulk-reject`,
    {
      document_ids: documentIds,
      reason,
    },
...
export const getOperationalMetrics = async (params = {}) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/admin/analytics/operational`,
      {
        headers: getAuthHeaders(),
        params,
      },
...
export const getCustomerAnalytics = async (params = {}) => {
  try {
    ...
    console.warn(
      "Customer analytics endpoint not available, using dashboard data",
    );
    try {
      const response = await axios.get(
        `${API_BASE_URL}/admin/analytics/dashboard`,
...
export const getShipmentReport = async (params = {}) => {
  try {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/admin/analytics/shipments`,
        {
          headers: getAuthHeaders(),
          params,
        },
...
export const exportRevenueReport = async (params = {}) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/admin/analytics/export/revenue`,
      params,
      {
        headers: getAuthHeaders(),
        responseType: "blob",
...
export const exportOperationalReport = async (params = {}) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/admin/analytics/export/operational`,
      params,
      {
        headers: getAuthHeaders(),
        responseType: "blob",
    ...
    link.setAttribute(
      "download",
      `operational-report-${new Date().toISOString().split("T")[0]}.xlsx`,
    );
    document.body.appendChild(link);
    link.click();
    link.remove();
    ...
    console.warn(
      "Operational export endpoint not available, using generic export",
    );
...
export const exportCustomerReport = async (params = {}) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/admin/analytics/export/customers`,
      params,
      {
        headers: getAuthHeaders(),
        responseType: "blob",
    ...
    link.setAttribute(
      "download",
      `customer-analytics-${new Date().toISOString().split("T")[0]}.xlsx`,
    );
    document.body.appendChild(link);
    link.click();
    link.remove();
    ...
    console.warn(
      "Customer export endpoint not available, using generic export",
    );
...
export const exportShipmentReport = async (params = {}) => {
  try {
    ...
    const response = await axios.post(
      `${API_BASE_URL}/admin/analytics/export/shipments`,
      params,
      {
        headers: getAuthHeaders(),
        responseType: "blob",
    ...
    link.setAttribute(
      "download",
      `shipment-report-${new Date().toISOString().split("T")[0]}.xlsx`,
    );
    document.body.appendChild(link);
    link.click();
    link.remove();
    ...
    console.warn(
      "Shipment export endpoint failed, trying alternative approaches",
    );
...
export const sendMessage = async (data) => {
  ...
  if (data.message_id) {
    const response = await axios.post(
      `${API_BASE_URL}/admin/messages/${data.message_id}/reply`,
      {
        reply: data.reply,
